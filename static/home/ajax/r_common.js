...
var  AjaxRequest=function(u,d,f){
	...
	$.ajax({
        ...
        beforeSend: function(xhr){
        	xhr.setRequestHeader('Request_Type','ajax');
        },
...
var Message={
		display:function(title,message){
			$('#resptitle').html(title);
			$('#respmsg').html(message);
			$(".JQdefrayalTips").css('display','block');
		},
		none:function(){
			$(".JQdefrayalTips").css('display','none');
			$('#resptitle').html('');
			$('#respmsg').html('');
		}
}
